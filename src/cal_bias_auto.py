...
def main(args):
    ...
    if not os.path.exists(f"../data/gender/result_wo_outliers/{model_name}/{target_group_name}_{args.replace_target}"):
        os.makedirs(f"../data/gender/result_wo_outliers/{model_name}/{target_group_name}_{args.replace_target}")
    ...
    if args.calculate_perplexity:
        ...
        df.to_csv(f"../data/gender/result_wo_outliers/{model_name}/{target_group_name}_{args.replace_target}/{model_name}_{target_group_name}_{args.replace_target}_output_{args.prompt_template}.csv")
    ...
    model_name = args.model_path.split('/')[-1]
    target_group_name = os.path.basename(args.attribute_category_path).split('-')[0]
    result_category.to_csv(f"../data/gender/result_wo_outliers/{model_name}/{target_group_name}_{args.replace_target}/{model_name}_{target_group_name}_{args.replace_target}_category_{args.prompt_template}.csv")
    result_category_all.to_csv(f"../data/gender/result_wo_outliers/{model_name}/{target_group_name}_{args.replace_target}/{model_name}_{target_group_name}_{args.replace_target}_category_all_{args.prompt_template}.csv")
    result_toxicity.to_csv(f"../data/gender/result_wo_outliers/{model_name}/{target_group_name}_{args.replace_target}/{model_name}_{target_group_name}_{args.replace_target}_toxicity_{args.prompt_template}.csv")
